...
if (isset($_POST['submitted'])) {
    ...
    if (is_numeric($_POST['kuantitas']) && is_numeric($_POST['harga'])) {
        ...
        // Menampilkan hasil:
        echo '<p>Biaya Total Belanja sebanyak ' . $_POST['kuantitas'] . ' barang dengan masing-masing seharga Rp.' . number_format ($_POST['harga'], 2) . ', termasuk pajak sebesar ' . $_POST['pajak'] . '%, adalah Rp.' . $jum . '.</p>';
