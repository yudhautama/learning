...
if ((!file_exists("PapanPesan/pesan.txt"))|| (filesize("PapanPesan/pesan.txt")==0) ) 
    ...
    foreach ($arrayPesanKunci as $pesan) { 
        ...
        "pesan=" . ($indeks - 1) . "'>Hapus Pesan ini</a>" . "</td>\n"; 
        echo "</tr>\n";
        ++$indeks;
...
?>
<p>
    <a href="kirim_pesanG.php">Kirim Pesan Baru</a><br>
    <a href="papan_pesanG.php?action=Hapus%20Pertama">Hapus Pesan Pertama</a><br>
    <a href="papan_pesanG.php?action=Hapus%20Akhir">Hapus Pesan Terakhir</a><br>
</p>   
    </body>
</html>